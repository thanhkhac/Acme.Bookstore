...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p d622e2b5-8190-4ef0-8e5c-efb06f44debe
```

> `d622e2b5-8190-4ef0-8e5c-efb06f44debe` is the password of the certificate, you can change it to any password you want.
