...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 7196c789-2839-41a2-82ba-79c2fe7dd782
```

> `7196c789-2839-41a2-82ba-79c2fe7dd782` is the password of the certificate, you can change it to any password you want.
